       ...
       <div class="panel-body">
        <form method="post" id="addForm" action="admin_product_add">
         <table class="addTable">
          ...
          <tr>
           <td>产品小标题</td>
           <td><input name="subTitle" id="subTitle" type="text" class="form-control" /></td>
          </tr>
          <tr>
           <td>原价格</td>
           <td><input name="promotePrice" id="promotePrice" type="text" class="form-control" value="0"/></td>
          </tr>
          <tr>
           <td>优惠价格</td>
           <td><input name="originalPrice" id="originalPrice" type="text" class="form-control" value="0"/></td>
          </tr>
          <tr>
           <td>库存</td>
           <td><input name="stock" id="stock" type="text" class="form-control" value="99"/></td>
          </tr>
          <tr class="submitTR">
